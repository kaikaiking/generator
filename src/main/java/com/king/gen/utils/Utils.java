...
public class Utils {
    ...
    public static boolean inTime(String startTime, String endTime) {
        ...
        return now >= Integer.parseInt(startTime) && now <= Integer.parseInt(endTime);
    }
...
//		}
     ...
     * @return String
     */
    public static String arrayToStringBySymbol(String[] arrays, String symbol) {
        symbol = StringUtils.isEmpty(symbol) ? "," : symbol;
